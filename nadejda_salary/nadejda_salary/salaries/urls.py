...
from .views import WorkerCreateView, MonthCreateView, DataFillView, WorkerUpdateView, DataUpdateView
...
urlpatterns = [
    ...
    path('update-data/<int:index>/', DataUpdateView.as_view(), name='update_data'),
]
